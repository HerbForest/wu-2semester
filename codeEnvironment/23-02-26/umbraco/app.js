...
var o = {
init: function(e) {
o.select2(), o.stellar(), o.carousel(), o.portfolio(), o.lightCase(),

o.sideNav(), o.counter(), o.skills(), o.aos(), o.navbarChange();
},
select2: function() {
n(e).ready(function() {
n("select").select2();
...
stellar: function() {
var e = n(t).width();
767 <= e && (n(".bg-fixed").attr("data-stellar-background-ratio",
...
dots: !1,
autoplay: !0,
autoplaySpeed: 1e3,navText: ['<span class="fa fa-angle-left"></span>', '<span class="fa
...
}), n(".btn-filter a.is-checked").addClass("active"), n(".btn-filter
...
n("body").removeClass("sidenav-open"), n("#side-
nav").css("width", "0");

}, 400);
}), n("#side-search-open").click(function() {
n("#side-search").css("width", "300"), setTimeout(function() {
n("body").addClass("sidesearch-open");}, 200), setTimeout(function() {
n("body").addClass("in");
}, 300);
...
n("body").removeClass("sidesearch-open"), n("#side-
search").css("width", "0");
...
return 150 < e ? (n("#header-navbar").removeClass("navbar-
transparent"), n("body").addClass("not-on-top")) : (n("body").removeClass("not-on-
top"), n("#header-navbar").addClass("navbar-transparent")), !1;
...
}(window.jQuery, window, document);function clearSelections(){
let targets = document.querySelectorAll('[data-cats]');
for (let index = 0; index < targets.length; ++index) {
let x =
targets[index].parentElement.parentElement.parentElement.parentElement.parentElement
;
...
if (element.innerText.toLowerCase().includes(category.toLowerCase())) {}
else {
...
let x =
newTargets[index].parentElement.parentElement.parentElement.parentElement.parentElem
ent;
if (x.style.display === "none") {
x.style.display = "block";
} else {
